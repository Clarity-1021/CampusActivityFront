                ...
                <v-expansion-panel v-for="conference in conferences" :key="conference" hide-actions><!--会议条目循环-->
                  <v-expansion-panel-header><!--简要条目陈列-->
                    <v-row align="center" class="spacer" no-gutters>
                      ...
                      <v-col class="text-center" cols="3">
                        <el-tag v-if="conference.audit_status==='fail'" class="tag-default" type=info>未通过</el-tag>
                        <el-tag v-if="conference.audit_status==='pass'" class="tag-default" type="info">已通过</el-tag>
                      </v-col>
                    </v-row>
                  </v-expansion-panel-header>
